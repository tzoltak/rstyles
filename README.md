...
-   Fixing or freeing slope parameters across items for each latent trait indiviually.
...
-   There is no way to include in the model many no-response-style latent traits loading different sets of items.
